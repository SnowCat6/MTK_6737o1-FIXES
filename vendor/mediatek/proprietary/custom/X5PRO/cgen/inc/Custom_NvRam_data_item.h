...
//<<hct:liuyang
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_CUSTOM_FMT_LID)
File_Custom_FMT_Struct *CFG_FILE_CUSTOM_FMT_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_CUSTOM_FMT_1_LID)
File_Custom_FMT_1_Struct *CFG_FILE_CUSTOM_FMT_1_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_CUSTOM_SNUM_LID)
File_Custom_SerialNumber_Struct *CFG_FILE_CUSTOM_SERIALNUMBER_TOTAL
{
