...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6735/ueventd.mt6735.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
else
...
PRODUCT_PACKAGES += libuvtswenc_sa.ca7.android
...
PRODUCT_PACKAGES += audio.usb.mt6735
PRODUCT_PACKAGES += audio.usb.mt6737t
PRODUCT_PACKAGES += audio.usb.mt6735m
PRODUCT_PACKAGES += audio.usb.mt6737m
...
PRODUCT_PACKAGES += thermal.mt6735
PRODUCT_PACKAGES += thermal.mt6737t
PRODUCT_PACKAGES += thermal.mt6735m
PRODUCT_PACKAGES += thermal.mt6737m
PRODUCT_PACKAGES += thermal.mt6753
...
PRODUCT_PACKAGES += audio.r_submix.mt6735
PRODUCT_PACKAGES += audio.r_submix.mt6737t
PRODUCT_PACKAGES += audio.r_submix.mt6735m
PRODUCT_PACKAGES += audio.r_submix.mt6737m
PRODUCT_PACKAGES += audio.r_submix.mt6753
PRODUCT_PACKAGES += libaudio.usb.default
...
PRODUCT_PACKAGES += power.mt6737t
PRODUCT_PACKAGES += power.mt6735m
PRODUCT_PACKAGES += power.mt6737m
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.mt6735.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6735.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.rc
ifeq ($(strip $(RAT_CONFIG_C2K_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.c2k.usb.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6735/factory_init.usb.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.usb.rc
endif
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.modem.rc:$(MTK_TARGET_VENDOR_RC)/init.modem.rc

ifeq ($(strip $(RAT_CONFIG_C2K_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.c2k.rc:$(MTK_TARGET_VENDOR_RC)/init.c2k.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/meta_init.c2k.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.c2k.rc
endif


ifeq ($(strip $(MTK_SENSORS_1_0)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.sensor_1_0.rc:$(MTK_TARGET_VENDOR_RC)/init.sensor_1_0.rc
endif
PRODUCT_COPY_FILES += device/mediatek/mt6735/meta_init.modem.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/meta_init.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.mt6735.usb.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6735.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.recovery.mt6735.rc:recovery/root/init.recovery.mt6735.rc
PRODUCT_COPY_FILES += device/mediatek/mt6735/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_tablet.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_basic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
endif
...
ifeq (yes 0x20000000,$(strip $(MTK_GMO_RAM_OPTIMIZE)) $(strip $(CUSTOM_CONFIG_MAX_DRAM_SIZE)))
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_video_gmo.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
  PRODUCT_COPY_FILES += device/mediatek/mt6735/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
else
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
  PRODUCT_COPY_FILES += device/mediatek/mt6735/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
endif
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6735/audio_device.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device.xml:mtk
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
    MTK_AUDIO_PARAM_DIR_LIST += device/mediatek/mt6735/audio_param
...
ifeq ($(strip $(MICROTRUST_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += keystore.mt6737m
  PRODUCT_PACKAGES += keystore.mt6753
  PRODUCT_PACKAGES += gatekeeper.mt6735
  ...
  PRODUCT_PACKAGES += kmsetkey.mt6735
  PRODUCT_PACKAGES += kmsetkey.mt6737t
  PRODUCT_PACKAGES += kmsetkey.mt6735m
  PRODUCT_PACKAGES += kmsetkey.mt6737m
  PRODUCT_PACKAGES += kmsetkey.mt6753
endif
